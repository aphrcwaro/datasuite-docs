...
<Callout type="info">
**References & Notes:**
1. Surveys can provide coverage of IFA supplementation, as here the unit of data analysis is individual pregnant women.
...
4. Therefore, the survey data on immunization roughly refer to the program performance in the year before the survey.
...
Navigate to the **Subnational Analysis** tab => **Subnational Inequality** and inspect the plotted regional and district results by year, with the median absolute deviation from the median (MADM), as the summary measure to assess if inequalities have reduced.
    ...
    ![National Inequality](/images/national-coverage-inequality.png)
