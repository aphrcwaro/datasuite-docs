...
## 18.2 Rationale, Approach, and Implementation

### Rationale: Scientific basis for the analysis
The assessment of the burden of disease, intervention coverage, quality, equity, and health system inputs should directly guide policy-making and program targeting. Subnational analyses are critical: districts, regions, and provinces serve as the primary implementation units for health systems and service delivery. A comprehensive evaluation requires a baseline comparison of health system inputs (such as financing, health workforce density, and infrastructure availability) against the corresponding outputs of the system (including service utilization and coverage rates).
...
**** insert_image: health_system_performance_module_interface ****


# 19 Health Systems Inputs

## 19.1 Health Systems Inputs Evaluation Framework
...
## 19.2 Input Indicators and Analytical Benchmarks
...
**** insert_image: subnational_health_inputs_scatter_matrix ****




# 20 Health Systems Outputs by Inputs

## 20.1 Health Systems Outputs by Inputs at the Sub-national Level
...
### 20.1.1 Association: Inpatient Infrastructure and Under-5 Hospital Admissions
...
### 20.1.2 Association: Health Workforce Density and Under-5 Outpatient Utilization
...
### 20.1.3 Association: Health Workforce Density and Institutional Live Birth Coverage
...
**** insert_image: 8-health_system_ratio_opd_u5_hwf.png ****