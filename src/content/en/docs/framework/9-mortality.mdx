# 16 Institutional Mortality

## 16.1 Rationale, Approach, and Implementation
...
![Annual trend plot of institutional maternal mortality ratio by region and national level](images/immr_trends_screenshot.png)

****insert maternal mortality per 1000***

### 16.2.1 Data Interpretation Considerations
...
***insert Insitutitonal MMR by region***
![Regional map displaying geographic variation of institutional maternal mortality ratios](images/immr_regional_map.png)
...
### 16.2.3 Data Interpretation Considerations for Stillbirths
...
***insert stillbirth rate chart***
![Annual trend plot of institutional stillbirth rate by region and national level](images/isbr_trends_screenshot.png)
...
***insert ratio of stillbirth chart*** 

### 16.2.4 Consistency of Institutional MMR with Population and Community Estimates
...
### 16.2.5 Mathematical Modeling and Formulations
...
### 16.2.6 Evaluation Scenarios and Interpretation
...
![Diagnostic plot tracking estimated facility reporting completeness across different MMR boundaries and community ratios](images/mmr_completeness_scenarios.png)
...
****insert completeness of facility maternal death***
...
****insert completness of facility stillbirth****

# 17 Methodological Footnotes and Technical Definitions
...
### 17.2 Data Quality and Imputation Guardrails
...
### 17.3 Modeling Assumptions and System Limitations
